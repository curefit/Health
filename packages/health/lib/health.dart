...
enum HealthDeviceType {
  ...
  static HealthDeviceType fromString(String? deviceModel) {
    ...
    if (lowercased.contains("watch")) {
      return HealthDeviceType.watch;
    }

    // iPhone detection
    if (lowercased.contains("iphone") || lowercased.contains("phone")) {
      return HealthDeviceType.phone;
    }

    // iPad detection
    if (lowercased.contains("ipad")) {
      return HealthDeviceType.ipad;
    }
    ...
    if (lowercased.contains("scale") ||
      ...
      return HealthDeviceType.scale;
    }

    // Ring detection (Oura, etc.)
    if (lowercased.contains("ring") || lowercased.contains("oura")) {
      return HealthDeviceType.ring;
    }
    ...
    if (lowercased.contains("band") ||
      ...
      return HealthDeviceType.fitnessBand;
    }
    ...
    if (lowercased.contains("chest") ||
      ...
      return HealthDeviceType.chestStrap;
    }
