...
| [movesense_plus](./packages/movesense_plus) | Movesens sensor communication. | ✔️ | ✔️  | [![pub package](https://img.shields.io/pub/v/movesense_plus.svg)](https://pub.dartlang.org/packages/movesense_plus) |
